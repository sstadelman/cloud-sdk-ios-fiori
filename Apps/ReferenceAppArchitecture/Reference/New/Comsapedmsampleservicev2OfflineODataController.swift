...
// FlowSpeedTest
//
// Created by SAP Cloud Platform SDK for iOS Assistant application on 25/06/20
//
...
public class Comsapedmsampleservicev2OfflineODataController: ODataControlling {
    ...
    public func configureOData(sapURLSession: SAPURLSession, serviceRoot: URL, onboardingID: UUID) throws {
        ...
        let delegate = Comsapedmsampleservicev2OfflineODataDelegateSample()
...
class Comsapedmsampleservicev2OfflineODataDelegateSample: OfflineODataProviderDelegate {
    private let logger = Logger.shared(named: "Comsapedmsampleservicev2OfflineODataController")
