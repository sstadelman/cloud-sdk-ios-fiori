...
// Reference
//
// Created by SAP Cloud Platform SDK for iOS Assistant application on 24/06/20
//
...
class AppDelegate: UIResponder, UIApplicationDelegate, ConnectivityObserver, UNUserNotificationCenterDelegate, UISceneDelegate {
    var window: UIWindow?
